    ...
    <div className="pt-20 min-h-screen bg-neutral-50 pb-20">
      ...
      <div className="bg-primary-600 text-white py-16 mb-12">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">{t('visit.title')}</h1>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto mb-12 bg-primary-50 border border-primary-100 rounded-2xl p-6 flex items-start gap-4">
          ...
          <div>
            <h3 className="font-bold text-primary-800 text-lg mb-2">{t('visit.info.title')}</h3>
            <p className="text-primary-700">
              <Trans i18nKey="visit.info.text">
                Ми працюємо у форматі <strong>антикафе</strong>. Це означає, що у нас немає кухні, кухарів та меню зі стравами. 
                Ви платите за час, проведений у компанії котиків. У нас можна читати, грати в настільні ігри, працювати або просто відпочивати душею.
              </Trans>
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-12">
          ...
          <div className="max-w-3xl mx-auto w-full">
            <div className="bg-white p-8 md:p-10 rounded-3xl shadow-sm border border-neutral-100 text-center">
              <h2 className="text-3xl font-bold text-primary-700 mb-8">{t('visit.pricing.title')}</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div className="p-6 bg-primary-50 rounded-2xl flex flex-col items-center justify-center gap-2 transition-transform hover:scale-105">
                  <span className="font-medium text-primary-800 text-lg">{t('visit.pricing.hour_1')}</span>
                ...
                <div className="p-6 bg-accent-50 rounded-2xl flex flex-col items-center justify-center gap-2 transition-transform hover:scale-105 border border-accent-100 relative overflow-hidden">
                  <span className="font-medium text-primary-800 text-lg">{t('visit.pricing.hour_2')}</span>
                ...
                <div className="p-6 bg-neutral-50 rounded-2xl flex flex-col items-center justify-center gap-2 transition-transform hover:scale-105 border border-neutral-100">
                  <span className="font-medium text-neutral-700 text-lg">{t('visit.pricing.hour_3')}</span>
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-sm text-neutral-400">{t('visit.pricing.book_note')}</p>
              </div>
            </div>
          </div>
